    ...
    <div className="space-y-4">
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
        <p className="text-sm text-amber-800">
          ...
          <strong>{reapariciones.length}</strong> predios eliminados reaparecieron y requieren aprobación del análisis técnico
        </p>
      </div>
      
      <div className="space-y-3">
        {reapariciones.map((reaparicion, idx) => (
          <Card key={idx} className={`border-l-4 ${selectedReaparicion?.codigo_predial_nacional === reaparicion.codigo_predial_nacional ? 'border-l-emerald-500 bg-emerald-50' : 'border-l-amber-500'}`}>
            <CardContent className="py-4">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <Badge variant="outline" className="bg-amber-100 text-amber-800">Reaparición</Badge>
                  ...
                  {selectedReaparicion?.codigo_predial_nacional === reaparicion.codigo_predial_nacional && (
                ...
                {selectedReaparicion?.codigo_predial_nacional !== reaparicion.codigo_predial_nacional && (
                  <Button
                    ...
                    variant="outline"
                    className="ml-3"
                    onClick={() => setSelectedReaparicion(reaparicion)}
                  >
